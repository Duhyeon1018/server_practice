        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg bg-body-tertiary">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="/search/list">목록가기</a>
            ...
            <div class="col">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary insertSearchBtn">글쓰기</button>
                        <table class="table">
                            <thead>
                            <%--                                소제목--%>
                            <tr>
                            ...
                            <c:forEach items="${pageResponseDTO.dtoList}" var="dto">
                                <tr>
                                    ...
                                    <td><a href="/search/read?tno=${dto.tno}&${pageRequestDTO.link}"
...
<script>
    document.querySelector(".insertSearchBtn").addEventListener("click",
        function (e) {
// 글쓰기 폼으로 가야함.
    ...
    document.querySelector(".pagination").addEventListener("click",
        function (e) {
            ...
            // 백틱, 숫자 키보드 1번 왼쪽에 보면.
            //  기존 페이지 이동해서,
            // self.location = `/search/list?page=\${num}`
            // 폼의 정보를 이용해서 이동.
